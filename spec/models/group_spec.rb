...
# Unit tests for FlatApi::Group
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlatApi::Group do
  let(:instance) { FlatApi::Group.new }

  describe 'test an instance of Group' do
    it 'should create an instance of Group' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlatApi::Group)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["generic", "classTeachers", "classStudents"])
