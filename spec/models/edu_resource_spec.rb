...
# Unit tests for FlatApi::EduResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlatApi::EduResource do
  let(:instance) { FlatApi::EduResource.new }

  describe 'test an instance of EduResource' do
    it 'should create an instance of EduResource' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlatApi::EduResource)
    end
  end
