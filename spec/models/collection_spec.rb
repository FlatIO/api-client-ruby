...
# Unit tests for FlatApi::Collection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlatApi::Collection do
  let(:instance) { FlatApi::Collection.new }

  describe 'test an instance of Collection' do
    it 'should create an instance of Collection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlatApi::Collection)
    end
  end
