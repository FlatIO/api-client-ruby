...
module FlatApi
  class OmrJobStatus
    ...
    AWAITING_INPUT = "awaitingInput".freeze
    DONE = "done".freeze
    ERROR = "error".freeze
    CANCELED = "canceled".freeze

    def self.all_vars
      @all_vars ||= [DRAFT, PROCESSING, AWAITING_INPUT, DONE, ERROR, CANCELED].freeze
    end
    ...
    def build_from_hash(value)
      return value if OmrJobStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #OmrJobStatus"
    end
  end
end
