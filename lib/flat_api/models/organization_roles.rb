...
module FlatApi
  class OrganizationRoles
    ADMIN = "admin".freeze
    ACCOUNT_ADMIN = "accountAdmin".freeze
    TEACHER = "teacher".freeze
    USER = "user".freeze

    def self.all_vars
      @all_vars ||= [ADMIN, ACCOUNT_ADMIN, TEACHER, USER].freeze
    end
    ...
    def build_from_hash(value)
      return value if OrganizationRoles.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #OrganizationRoles"
    end
  end
end
