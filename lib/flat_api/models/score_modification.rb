...
module FlatApi
  ...
  class ScoreModification
    ...
    def list_invalid_properties
      ...
      if !@sharing_key.nil? && @sharing_key !~ Regexp.new(/^[a-f0-9]{128}$/)
        invalid_properties.push("invalid value for 'sharing_key', must conform to the pattern /^[a-f0-9]{128}$/.")
      end
    ...
    def sharing_key=(sharing_key)
      ...
      if !sharing_key.nil? && sharing_key !~ Regexp.new(/^[a-f0-9]{128}$/)
        fail ArgumentError, "invalid value for 'sharing_key', must conform to the pattern /^[a-f0-9]{128}$/."
      end
    ...
    def hash
      [privacy, sharing_key, description, tags, creation_type, license].hash
    end
