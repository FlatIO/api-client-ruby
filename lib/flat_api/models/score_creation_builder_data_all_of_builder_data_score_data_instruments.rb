...
module FlatApi
  class ScoreCreationBuilderDataAllOfBuilderDataScoreDataInstruments < ApiModelBase
    ...
    attr_accessor :has_quarter_tone
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FlatApi::ScoreCreationBuilderDataAllOfBuilderDataScoreDataInstruments` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlatApi::ScoreCreationBuilderDataAllOfBuilderDataScoreDataInstruments`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'has_quarter_tone')
        self.has_quarter_tone = attributes[:'has_quarter_tone']
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] instrument Value to be assigned
    def instrument=(instrument)
      if instrument.nil?
        fail ArgumentError, 'instrument cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          has_quarter_tone == o.has_quarter_tone
    end
    ...
    def hash
      [group, instrument, long_name, short_name, has_quarter_tone].hash
    end
