...
module FlatApi
  ...
  class OrganizationInvitation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customCode')
        self.custom_code = attributes[:'customCode']
      end
      ...
      if attributes.has_key?(:'invitedBy')
        self.invited_by = attributes[:'invitedBy']
      end

      if attributes.has_key?(:'usedBy')
        self.used_by = attributes[:'usedBy']
      end
    ...
    def hash
      [id, organization, organization_role, custom_code, email, invited_by, used_by].hash
    end
