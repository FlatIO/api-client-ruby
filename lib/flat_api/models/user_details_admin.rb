...
module FlatApi
  ...
  class UserDetailsAdmin < ApiModelBase
    ...
    # Indicates if the user account is marked as a testing student account. Testing students are typically excluded from certain educational integrations and workflows. This field helps API clients distinguish between regular students and testing accounts. 
    attr_accessor :is_edu_testing_student
    ...
    def self.openapi_types
      {
        ...
        :'groups' => :'Array<String>',
        :'is_edu_testing_student' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlatApi::UserDetailsAdmin`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_edu_testing_student')
        self.is_edu_testing_student = attributes[:'is_edu_testing_student']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          license == o.license &&
          groups == o.groups &&
          is_edu_testing_student == o.is_edu_testing_student
    end
    ...
    def hash
      [id, type, product, username, printable_name, firstname, lastname, name, picture, badges, organization, organization_role, class_role, html_url, email, last_activity_date, license, groups, is_edu_testing_student].hash
    end
