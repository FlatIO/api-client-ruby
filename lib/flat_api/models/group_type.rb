...
module FlatApi
  class GroupType
    ...
    CLASS_STUDENTS_SUB_GROUP = "classStudentsSubGroup".freeze
    ASSIGNMENT_STUDENTS_SUB_GROUP = "assignmentStudentsSubGroup".freeze

    def self.all_vars
      @all_vars ||= [GENERIC, CLASS_TEACHERS, CLASS_STUDENTS, CLASS_STUDENTS_SUB_GROUP, ASSIGNMENT_STUDENTS_SUB_GROUP].freeze
    end
    ...
    def build_from_hash(value)
      return value if GroupType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #GroupType"
    end
  end
end
