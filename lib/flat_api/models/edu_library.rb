  ...
  class EduLibrary < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FlatApi::EduLibrary` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlatApi::EduLibrary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["myResources", "organizationResources", "flatEduContent"])
      return false unless type_validator.valid?(@type)
      return false if @visibility.nil?
      visibility_validator = EnumAttributeValidator.new('String', ["private", "organization", "public"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["myResources", "organizationResources", "flatEduContent"])
    ...
    def visibility=(visibility)
      validator = EnumAttributeValidator.new('String', ["private", "organization", "public"])
