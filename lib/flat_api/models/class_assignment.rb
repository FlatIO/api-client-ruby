...
module FlatApi
  class ClassAssignment < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'assigned_groups' => :'Array<AssignmentGroup>',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlatApi::ClassAssignment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'assigned_groups')
        if (value = attributes[:'assigned_groups']).is_a?(Array)
          self.assigned_groups = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          assigned_groups == o.assigned_groups &&
