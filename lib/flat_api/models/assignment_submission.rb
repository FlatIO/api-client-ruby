...
module FlatApi
  ...
  class AssignmentSubmission < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] assignment Value to be assigned
    def assignment=(assignment)
      if assignment.nil?
        fail ArgumentError, 'assignment cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] playback Value to be assigned
    def playback=(playback)
      if playback.nil?
        fail ArgumentError, 'playback cannot be nil'
      end
