...
module FlatApi
  class AssignmentSubmissionStudentsMode
    SINGLE = "single".freeze
    GROUP = "group".freeze

    def self.all_vars
      @all_vars ||= [SINGLE, GROUP].freeze
    end
    ...
    def build_from_hash(value)
      return value if AssignmentSubmissionStudentsMode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AssignmentSubmissionStudentsMode"
    end
  end
end
