...
module FlatApi
  class ClassAssignmentUpdate < ApiModelBase
    attr_accessor :type
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlatApi::ClassAssignmentUpdate`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_group_ids')
        if (value = attributes[:'class_group_ids']).is_a?(Array)
          self.class_group_ids = value
        end
      end
    end
    ...
    def max_points=(max_points)
      if max_points.nil?
        fail ArgumentError, 'max_points cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          class_group_ids == o.class_group_ids
    end
