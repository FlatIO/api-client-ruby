...
module FlatApi
  class OmrJobOutput
    ...
    MUSICXML = "musicxml".freeze

    def self.all_vars
      @all_vars ||= [LIBRARY, MUSICXML].freeze
    end
    ...
    def build_from_hash(value)
      return value if OmrJobOutput.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #OmrJobOutput"
    end
  end
end
