...
module FlatApi
  class CollectionApi
    ...
    # @param collection [String] Unique identifier of the collection.  The following collection aliases are supported: - &#x60;root&#x60;: **Deprecated.** The root collection of the account - &#x60;app&#x60;: Alias for the current app collection - &#x60;trash&#x60;: Automatically contains resources that have been deleted 
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :parent List the collections contained in this &#x60;parent&#x60; collection.  When set to &#x60;user&#x60; (default), returns the user&#39;s own collections as well as collections shared with the user.  Using &#x60;root&#x60; or &#x60;sharedWithMe&#x60; is **deprecated** and will be treated as &#x60;user&#x60;.  (default to 'user')
    # @option opts [String] :sort Sort
    # @option opts [String] :direction Sort direction
    # @option opts [Integer] :limit This is the maximum number of objects that may be returned (default to 25)
    # @option opts [String] :_next An opaque string cursor to fetch the next page of data. The paginated API URLs are returned in the &#x60;Link&#x60; header when requesting the API. These URLs will contain a &#x60;next&#x60; and &#x60;previous&#x60; cursor based on the available data. 
    ...
    # @param collection [String] Unique identifier of the collection.
    # @param [Hash] opts the optional parameters
    # @return [FlatErrorResponse]
    def untrash_collection(collection, opts = {})
      data, _status_code, _headers = untrash_collection_with_http_info(collection, opts)
      data
    end
    ...
    # @param collection [String] Unique identifier of the collection.
    # @param [Hash] opts the optional parameters
    # @return [Array<(FlatErrorResponse, Integer, Hash)>] FlatErrorResponse data, response status code and response headers
    def untrash_collection_with_http_info(collection, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'FlatErrorResponse'
