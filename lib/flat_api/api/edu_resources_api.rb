...
module FlatApi
  class EduResourcesApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :parent List the resources contained in this &#x60;parent&#x60; library or folder.  Accepts a folder identifier, or the identifier of one of the libraries returned by [&#x60;listEduLibraries&#x60;](#tag/EduResources/operation/listEduLibraries). Which libraries are available depends on the account, so use the &#x60;id&#x60; values that endpoint returns rather than hardcoding this list:  * &#x60;root&#x60;: the user&#39;s own resources * &#x60;organization&#x60;: resources shared with the organization  (default to 'root')
    # @option opts [Boolean] :without_subfolders_resources For the &#x60;parent&#x60; &#x3D; &#x60;organization&#x60;, do not include resources from subfolders. By default in the Resource Library UI, we include resources from subfolders, but for example in a picker like LTI, we don&#39;t want to include them. 
    # @option opts [String] :type Filter the returned resources by type 
    # @option opts [Array<TeachingTheme>] :subjects Filter the returned resources by subjects 
    # @option opts [Array<AssignmentType>] :assignment_types Filter the returned resources by assignment types 
    # @option opts [Array<Grade>] :grades Filter the returned resources by grades 
    ...
    def list_edu_resources_with_http_info(opts = {})
      ...
      query_params[:'withoutSubfoldersResources'] = opts[:'without_subfolders_resources'] if !opts[:'without_subfolders_resources'].nil?
      query_params[:'type'] = opts[:'type'] if !opts[:'type'].nil?
      query_params[:'subjects'] = @api_client.build_collection_param(opts[:'subjects'], :multi) if !opts[:'subjects'].nil?
      query_params[:'assignmentTypes'] = @api_client.build_collection_param(opts[:'assignment_types'], :multi) if !opts[:'assignment_types'].nil?
      query_params[:'grades'] = @api_client.build_collection_param(opts[:'grades'], :multi) if !opts[:'grades'].nil?
