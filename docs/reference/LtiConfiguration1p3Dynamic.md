...
| **registration_token_used** | **Boolean** | Whether dynamic registration token has been used | [optional] |
| **registration_completion_date** | **Time** | Date when dynamic registration completed (null when not completed) | [optional] |
...
instance = FlatApi::LtiConfiguration1p3Dynamic.new(
  id: null,
  lti_version: null,
  ...
  registration_completion_date: null
)
```
