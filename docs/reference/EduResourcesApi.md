...
opts = {
  ...
  grades: [FlatApi::Grade::N1], # Array<Grade> | Filter the returned resources by grades 
...
| **grades** | [**Array&lt;Grade&gt;**](Grade.md) | Filter the returned resources by grades  | [optional] |
