...
release line (0.3.x) was generated in 2024 or earlier and is missing everything the API has
shipped since.

The previous major stays installable and is deprecated on RubyGems, not withdrawn. Nothing breaks
...
3. **Supported runtimes moved up** to Ruby 3.3 and 3.4. End-of-life runtimes are no longer supported.
...
2. Bump the dependency: `gem install flat_api`.
